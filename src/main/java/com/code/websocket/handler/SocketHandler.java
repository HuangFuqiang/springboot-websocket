package com.code.websocket.handler;

import com.code.websocket.utils.JsonUtil;
import com.code.websocket.model.WsParam;
import com.code.websocket.model.WsResponse;
...
public class SocketHandler extends TextWebSocketHandler {
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        logger.info("msg = " + msg);
        WsParam<String> wsParam = JsonUtil.json2Bean(msg, new TypeReference<WsParam<String>>(){});
        if ("list".equals(wsParam.getMethod())) {
            ...
            sendMessageToUser(session, new TextMessage(JsonUtil.bean2Json(response)));
        }
